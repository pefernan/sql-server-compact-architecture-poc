...
public class ProtostreamObjectMarshaller implements ObjectMarshallerStrategy {
    ...
    public ProtostreamObjectMarshaller() {
        ...
        try {
            ...
            context.registerMarshaller(new org.kie.kogito.app.CandidateDataMessageMarshaller());
            context.registerMarshaller(new org.kie.kogito.app.OfferMessageMarshaller());
        } catch (IOException e) {
        }
    }
