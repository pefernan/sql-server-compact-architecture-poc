...
public class Flow3_TaskModelFactory {

    public static TaskModel from(org.kie.kogito.process.WorkItem workItem) {
        switch(workItem.getNodeId().toExternalFormat()) {
            case "_70D7CFA5-5390-417B-B866-75274FF9C00A":
                return Flow3__70D7CFA5_5390_417B_B866_75274FF9C00A_TaskModel.from(workItem);
            default:
