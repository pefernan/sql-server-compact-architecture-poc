...
public class Flow2Process extends org.kie.kogito.process.impl.AbstractProcess<org.kogito.poc.Flow2Model> {

    @jakarta.inject.Inject()
    public Flow2Process(org.kie.kogito.app.Application app, org.kie.kogito.correlation.CorrelationService correlations, org.kie.kogito.process.ProcessInstancesFactory factory) {
    ...
    @Override()
    public org.kogito.poc.Flow2ProcessInstance createInstance(org.kogito.poc.Flow2Model value) {
        return new org.kogito.poc.Flow2ProcessInstance(this, value, this.createProcessRuntime());
    }

    public org.kogito.poc.Flow2ProcessInstance createInstance(java.lang.String businessKey, org.kogito.poc.Flow2Model value) {
        return new org.kogito.poc.Flow2ProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    public org.kogito.poc.Flow2ProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.correlation.CompositeCorrelation correlation, org.kogito.poc.Flow2Model value) {
        return new org.kogito.poc.Flow2ProcessInstance(this, value, businessKey, this.createProcessRuntime(), correlation);
    }

    @Override()
    public org.kogito.poc.Flow2Model createModel() {
        return new org.kogito.poc.Flow2Model();
    }

    public org.kogito.poc.Flow2ProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((org.kogito.poc.Flow2Model) value);
    }

    public org.kogito.poc.Flow2ProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (org.kogito.poc.Flow2Model) value);
    }

    public org.kogito.poc.Flow2ProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.kogito.poc.Flow2ProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public org.kogito.poc.Flow2ProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.kogito.poc.Flow2ProcessInstance(this, this.createModel(), wpi);
    }

    protected org.kie.api.definition.process.Process process() {
        RuleFlowProcessFactory factory = RuleFlowProcessFactory.createProcess("flow2", true);
        factory.name("flow2");
